...
scp scripts/install-spark-user.sh scripts/install-python-headers.sh scripts/serve-spark-user.sh scripts/canvas-runtime.py scripts/verify_runtime.py scripts/patch_diffusion_controls.py scripts/patch_diffusion_metrics.py scripts/patch_diffusion_preview.py scripts/patch_diffusion_probabilities.py scripts/patch_ar_temperature.py "$target:.local/share/spark-gemma-lab/"
